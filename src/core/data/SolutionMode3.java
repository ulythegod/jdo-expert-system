 ...
 * Time: 11:26
 */
public class SolutionMode3 {
    private int solutionMode3Id;
    ...
    public SolutionMode3(String nameSolution, String dateCreate, int calcYear, Agricultures agriculture) {
    ...
    public int getSolutionMode3Id() {
        return solutionMode3Id;
    }

    public void setSolutionMode3Id(int solutionMode3Id) {
        this.solutionMode3Id = solutionMode3Id;
    }
